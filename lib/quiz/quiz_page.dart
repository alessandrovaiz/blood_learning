...
import 'package:blood_learning/shared/store/answers_store.dart';
import 'package:blood_learning/shared/store/modules_store.dart';
import 'package:blood_learning/shared/store/questions_store.dart';
...
class _QuizState extends State<Quiz> {
  ...
  _buildQuestionTile(BuildContext context, int i) {
                  ...
                  child: Padding(
                    ...
                    child: Container(
                      ...
                      SweetAlert.show(context,
                          ...
                          completeModule(id: widget._moduleId, status: 1);
   ...
   _buildQuestionContainer(int i, int index, BuildContext context) {
    return Container(
    ...
    child: Padding(
      ...
      children: [
        Flexible(
                  child: Padding(
                    padding: const EdgeInsets.all(8.0),
                    child: Text(questions[i].answers[index].desc,
                          style: TextStyle(
                      color: AppColors().dark,
  ...
  Future<List<Question>> _getQuestions(int module) async {
    ...
    await getQuestion(module).then((value) {
      questions = value;
    ...
    if (this.questions != null) {
      for (Question q in this.questions) {
        await getAnswers(q.id).then((value) {
          if (value != null) {
            q.answers = value;
